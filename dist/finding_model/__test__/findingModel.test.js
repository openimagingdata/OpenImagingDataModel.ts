...
import { FindingModel, findingModelSchema, } from "../finding_model.js";
import { Either } from "effect";
const findingJson = {
    name: "calcified pulmonary granuloma",
    description: "A type of small lesion in the lungs, often caused by inflammation from diseases such as tuberculosis. These granulomas become calcified as they heal, leaving behind a small area of lung tissue that is harder than normal due to the deposition of calcium salts.",
    attributes: [
        {
            name: "size",
        ...
        {
            name: "change",
            description: "The change in the size or number of granulomas since the prior imaging study",
            type: "choice",
            values: [
                {
                    name: "new",
                    description: "The granuloma was not present in the prior imaging study",
                },
                {
                    name: "unchanged",
                    description: "The granuloma is the same size as in the prior imaging study",
                },
                {
                    name: "enlarging",
                    description: "The granuloma is larger than in the prior imaging study",
                },
                {
                    name: "no significant change",
                    description: "There is no significant change in the size or number of granulomas since the prior imaging study",
                },
            ],
        },
    ],
...
describe("findingModel", () => {
    it("should create a new FindingModel from finding model data", () => {
        ...
        expect(findingModel).toHaveProperty("description", "A type of small lesion in the lungs, often caused by inflammation from diseases such as tuberculosis. These granulomas become calcified as they heal, leaving behind a small area of lung tissue that is harder than normal due to the deposition of calcium salts.");
...
describe("Encoding", () => {
    it("Encoding from data to FindingModel", () => {
        const encodedDataEither = Schema.encodeEither(findingModelSchema)(findingJson);
        if (Either.isRight(encodedDataEither)) {
            ...
            expect(encodedData).toHaveProperty("name", "calcified pulmonary granuloma");
            expect(encodedData).toHaveProperty("description", "A type of small lesion in the lungs, often caused by inflammation from diseases such as tuberculosis. These granulomas become calcified as they heal, leaving behind a small area of lung tissue that is harder than normal due to the deposition of calcium salts.");
...
describe("Decoding", () => {
    it("Decoding from FindingModel data", () => {
        ...
        if (Either.isRight(decodedFinding)) {
            ...
            expect(decodedData).toHaveProperty("name", "calcified pulmonary granuloma");
            expect(decodedData).toHaveProperty("description", "A type of small lesion in the lungs, often caused by inflammation from diseases such as tuberculosis. These granulomas become calcified as they heal, leaving behind a small area of lung tissue that is harder than normal due to the deposition of calcium salts.");
...
//# sourceMappingURL=findingModel.test.js.map
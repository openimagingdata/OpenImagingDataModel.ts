...
import { BaseElement, ValueSetElement, valueSetElementSchema, CdElementFactory, } from "../cde_element.js";
...
describe("Encoding", () => {
    it("Encoding from data to ValueSetElement", () => {
        const encodedDataEither = Schema.encodeEither(valueSetElementSchema)(valueSetElementdata);
        if (Either.isRight(encodedDataEither)) {
            ...
            expect(encodedData.value_set.values[0]).toHaveProperty("code", "RDE1695.0");
...
describe("Decoding from ValueSetElementData", () => {
    it("Decoding from ValueSetElementData", () => {
        ...
        if (Either.isRight(decodedValueSetElementEither)) {
            ...
            expect(decodedValueSetElement.value_set).toHaveProperty("min_cardinality", 1);
            expect(decodedValueSetElement.value_set).toHaveProperty("max_cardinality", 1);
            ...
            expect(decodedValueSetElement.value_set.values[0]).toHaveProperty("code", "RDE1695.0");
        }
        else {
...
//# sourceMappingURL=cde_element.test.js.map
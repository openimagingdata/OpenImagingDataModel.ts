...
import { IntegerElement, FloatElement, ValueSetElement, BooleanElement, } from "../cde_element.js";
import { CdeSet } from "../cde_set.js";
import { createSet, createIntegerElement, createFloatElement, createBooleanElement, createValueSetElement, createSetFromFindingModel, } from "../factory.js";
...
describe("SetFactory", () => {
    ...
    it("should create an IntegerElement correctly", () => {
        const integerElement = createIntegerElement("Test Element", 1, 10, 1, "units");
    ...
    it("should create a FloatElement correctly", () => {
        const floatElement = createFloatElement("Test Float", 0.1, 10.1, 0.1, "units");
    ...
    it("should create a ValueSetElement with valid input", () => {
        ...
        const element = createValueSetElement(name, values, definition, question, 1, 1);
    ...
    it("should throw an error for ValueSetElement with less than two values", () => {
        expect(() => createValueSetElement("Single Value", [{ name: "Only One" }])).toThrow("Value set must have at least two values");
    });
